      ...
      <div className="relative max-w-7xl mx-auto px-6 py-24 sm:py-32 lg:px-8">
        <div className="max-w-2xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#00A4A6]/10 backdrop-blur-sm border border-[#36C2C6]/30 rounded-full mb-6">
            ...
            <span className="text-sm font-medium text-[#A4E6E0]">AI-assisterad årsplanering</span>
          </div>

          {/* Main Heading - white with teal accent */}
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6 leading-tight">
            Året i en bild –{' '}
            <span className="text-[#36C2C6]">fatta beslut snabbare</span>
          </h1>

          {/* Description */}
          <p className="text-xl text-[#A4E6E0]/90 mb-8 leading-relaxed">
            YearWheel gör din årsplanering tydlig, samlad och lätt att agera på. 
            Se hela året på en gång, hitta luckor och krockar direkt – allt med AI-assistans.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              href="#demo"
              className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-[#36C2C6]/30 rounded-sm transition-all duration-200"
            >
          ...
          <div className="mt-12 grid grid-cols-3 gap-8 pt-8 border-t border-[#36C2C6]/20">
            <div>
              <div className="text-3xl font-bold text-white">0 kr</div>
              <div className="text-sm text-[#A4E6E0]/70 mt-1">att komma igång</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white">3 hjul</div>
              <div className="text-sm text-[#A4E6E0]/70 mt-1">gratis för alltid</div>
            </div>
            <div>
              <div className="text-3xl font-bold text-white">∞</div>
              <div className="text-sm text-[#A4E6E0]/70 mt-1">med Premium</div>
            </div>
          </div>
        </div>
      </div>
