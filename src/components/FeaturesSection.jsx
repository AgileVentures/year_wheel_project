    ...
    <section id="features-section" className="py-20 px-4 sm:px-6 lg:px-8 scroll-mt-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Feature 1 - Circular Overview */}
          <div className="bg-gradient-to-br from-[#A4E6E0]/20 to-white p-8 rounded-sm border border-[#36C2C6]/30 hover:shadow-lg transition-shadow relative overflow-hidden">
            <div className="absolute top-3 right-3 bg-gray-100 text-gray-700 px-3 py-1 text-xs font-bold rounded-full">
          ...
          <div className="bg-gradient-to-br from-[#9FCB3E]/20 to-white p-8 rounded-sm border border-[#9FCB3E]/30 hover:shadow-lg transition-shadow relative overflow-hidden">
            <div className="absolute top-3 right-3 bg-gray-100 text-gray-700 px-3 py-1 text-xs font-bold rounded-full">
              {t('landing:features.free')}
            </div>
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">
              {t('landing:features.realTimeCollaboration.title')}</h3>
            <p className="text-gray-600">
              {t('landing:features.realTimeCollaboration.description')}
            </p>
          </div>

          {/* Feature 3 - Smart Rings */}
          <div className="bg-gradient-to-br from-[#A4E6E0]/20 to-white p-8 rounded-sm border border-[#2E9E97]/30 hover:shadow-lg transition-shadow relative overflow-hidden">
            <div className="absolute top-3 right-3 bg-gray-100 text-gray-700 px-3 py-1 text-xs font-bold rounded-full">
              {t('landing:features.free')}
            </div>
          ...
          <div className="bg-gradient-to-br from-[#A4E6E0]/20 to-white p-8 rounded-sm border border-[#36C2C6]/30 hover:shadow-lg transition-shadow relative overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">
              {t('landing:features.highQualityExport.title')}</h3>
            <p className="text-gray-600">
          ...
          {/* Feature 5 - Comments */}
          <div className="bg-gradient-to-br from-[#9FCB3E]/20 to-white p-8 rounded-sm border border-[#336B3E]/30 hover:shadow-lg transition-shadow relative overflow-hidden">
            <div className="absolute top-3 right-3 bg-gray-100 text-gray-700 px-3 py-1 text-xs font-bold rounded-full">
              {t('landing:features.free')}
            </div>
            <div className="w-12 h-12 bg-[#336B3E] rounded-sm flex items-center justify-center mb-6">
          ...
          {/* Feature 6 - Multiple Share Modes */}
          <div className="bg-gradient-to-br from-[#A4E6E0]/20 to-white p-8 rounded-sm border border-[#00A4A6]/30 hover:shadow-lg transition-shadow relative overflow-hidden">
            <div className="absolute top-3 right-3 bg-gray-100 text-gray-700 px-3 py-1 text-xs font-bold rounded-full">
              {t('landing:features.free')}
            </div>
            <div className="w-12 h-12 bg-[#00A4A6] rounded-sm flex items-center justify-center mb-6">
          ...
          {/* Feature 7 - AI Assistant (PREMIUM) */}
          ...
          {/* Feature 8 - Email Reminders (PREMIUM) */}
          <div className="bg-gradient-to-br from-[#A4E6E0]/20 to-white p-8 rounded-sm border-2 border-[#36C2C6] hover:shadow-xl transition-all relative overflow-hidden">
            <div className="absolute top-3 right-3 bg-[#9FCB3E] text-[#1a3d1f] px-3 py-1 text-xs font-bold rounded-full flex items-center gap-1">
              <Crown size={12} />
              {t('landing:features.premium')}
            </div>
            <div className="w-12 h-12 bg-gradient-to-br from-[#00A4A6] to-[#36C2C6] rounded-sm flex items-center justify-center mb-6">
              <Bell className="text-white" size={24} />
            </div>
            <h3 className="text-xl font-bold text-gray-900 mb-3">
              {t('landing:features.emailReminders.title')}
            </h3>
            <p className="text-gray-600">
          ...
          {/* Feature 9 - Google Integration (PREMIUM) */}
          ...
          {/* Feature 11 - Version History (PREMIUM) */}
          <div className="bg-gradient-to-br from-[#A4E6E0]/20 to-white p-8 rounded-sm border-2 border-[#2D4EC8] hover:shadow-xl transition-all relative overflow-hidden">
            <div className="absolute top-3 right-3 bg-[#9FCB3E] text-[#1a3d1f] px-3 py-1 text-xs font-bold rounded-full flex items-center gap-1">
              <Crown size={12} />
              {t('landing:features.premium')}
