...
function ConfirmDialog() {
  ...
  const isConfirmDisabled = dialog.requireConfirmation && 
    confirmationInput !== dialog.confirmationText;
        ...
        <div className="bg-white  rounded-sm shadow-xl max-w-md w-full animate-scale-in">
            ...
            {dialog.requireConfirmation && (
              <div className="mt-4">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-sm focus:outline-none focus:ring-2 focus:ring-red-500"
                  placeholder={dialog.confirmationText}
                  autoFocus
                />
              </div>
            )}
          ...
          <div className="flex justify-end gap-3 px-6 py-4 bg-gray-50 rounded-b-lg">
            ...
            <button
              ...
              className={`px-4 py-2 text-sm font-medium rounded-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${dialog.confirmButtonClass}`}
