...
![YearWheel landing page](images/QUICK_START_01_landing_page.png)
*YearWheel landing page - click "Get Started Free" to begin*

1. Go to [yearwheel.com](https://yearwheel.com)
2. Click **"Get Started Free"**

![Login form](images/QUICK_START_02_login_box.png)
...
![Dashboard](images/QUICK_START_03_dashboard.png)
*Your dashboard - here you see all your year wheels*

1. Click **"Create New Wheel"** on your dashboard

![Create new wheel modal](images/QUICK_START_04_create_wheel.png)
...
![New wheel created](images/QUICK_START_05_wheel_created.png)
...
![Editor with rings](images/QUICK_START_06_editor.png)
...
![Editor with configured rings](images/QUICK_START_07_editor_with_changes_01.png)
...
![Create new activity modal](images/QUICK_START_08_create_new_activity.png)
...
![Wheel with first activity](images/QUICK_START_09_editor_with_changes_02.png)
...
![Create recurring activity](images/QUICK_START_10_create_recurring_activity.png)
...
![Wheel with multiple activities](images/QUICK_START_11_editor_with_changes_03.png)
...
![Drag and drop in action](images/QUICK_START_12_drag_and_drop.png)
*When you hover over an activity, the hand icon appears - click and drag to move*

![Zoomed view of drag and drop](images/QUICK_START_13_drag_and_drop_zoomed_in.png)
