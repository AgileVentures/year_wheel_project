...
**Mål**: Skapa ditt första årshjul och lägg till aktiviteter

---

## Steg 1: Skapa ditt konto

![YearWheel startsida](images/QUICK_START_01_landing_page.png)
*YearWheels startsida - klicka på "Kom igång gratis" för att börja*
...
1. Öppna vänstra sidofältet (klicka på ☰ om det är stängt)
2. Hitta avsnittet **"Inre ringar"** - ditt nya hjul börjar med en standardring som heter "Ring 1"
3. **Klicka direkt på "Ring 1"** för att redigera namnet
4. Skriv din första kategori (t.ex. "Marknadsföring") och tryck Tab eller klicka utanför
5. Klicka på **"+ Lägg till"** för att lägga till fler ringar (sikta på 3-5 totalt)
6. Namnge varje ring efter dina huvudkategorier

**Exempel på ringar:**
- **För affärsplanering**: Marknadsföring, Försäljning, Produkt, Drift
- **För personlig planering**: Privat, Familj, Arbete, Hälsa
...
## Steg 4: Skapa aktivitetsgrupper

**Aktivitetsgrupper** bestämmer färgen på dina aktiviteter. Tänk på dem som färgkodningskategorier - alla aktiviteter i samma grupp får samma färg på ditt hjul.

1. Scrolla till avsnittet **"Aktivitetsgrupper"** (under ringarna)
2. Klicka på **"+ Lägg till aktivitetsgrupp"**
3. Ange ett namn (t.ex. "Kampanjer")
4. Välj en färg (t.ex. blå)
5. Klicka på **"Lägg till"**
6. Upprepa för att skapa 3-4 fler grupper med olika färger

**Exempel på grupper:**
- **Efter typ**: Kampanjer, Event, Återkommande uppgifter, Milstolpar
- **Efter status**: Planerad, Pågående, Slutförd
- **Efter prioritet**: Hög prioritet, Medel prioritet, Låg prioritet

**Varför färger är viktiga**: 
När du har många aktiviteter på ditt hjul hjälper färger dig att omedelbart se mönster - som att se alla Q2-aktiviteter på en gång, eller identifiera alla högprioriterade objekt.

---

## Steg 5: Lägg till din första aktivitet
...
## Steg 6: Lägg till fler aktiviteter

Skapa 2-3 fler aktiviteter för att se hur hjulet byggs upp. Varje aktivitet staplas ovanpå andra i samma ring, vilket skapar en komplett visuell bild av ditt år.
...
## Steg 7: Prova dra-och-släpp-redigering

Du kan flytta och ändra storlek på aktiviteter direkt på hjulet!

**Flytta en aktivitet:**
1. **Placera muspekaren** över en aktivitet på hjulet
2. **Klicka och håll** i mitten av aktiviteten
3. **Dra** till en annan månad eller tidsperiod
4. **Släpp** för att placera

Start- och slutdatumen uppdateras automatiskt! ✨

**Ändra storlek på en aktivitet:**
1. **Placera muspekaren** över kanten på en aktivitet (vänster eller höger kant)
2. Vänta tills markören ändras till storleksändringsikoner
3. **Klicka och dra** kanten för att göra den längre eller kortare
4. **Släpp** när du är klar
...
Nu när du har grunderna, utforska dessa kraftfulla funktioner:

- **Zoomkontroller**: Använd fliken Zoom i sidofältet för att fokusera på specifika månader eller kvartal (perfekt för planeringsmöten!)
- **[Presentationsläge](08_PRESENTATION_sv.md)** - Dölj ringar med kryssrutor för att skapa olika vyer för olika målgrupper
- **[Export](11_EXPORT_sv.md)** - Ladda ner ditt hjul som PNG, PDF, SVG eller JPG för presentationer
- **[Team](09_TEAMS_sv.md)** - Bjud in kollegor för att samarbeta på delade hjul
...
**Tips**: YearWheel sparar automatiskt varje ändring. Håll utkik efter indikatorn "Sparat ✓" i övre huvudet!
