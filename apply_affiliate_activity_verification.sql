...
-- 2. Update affiliate_commissions status constraint
...
-- 3. Function to check if a user meets activity requirements
...
-- 4. Function to verify affiliate commission after 14 days
...
-- 5. Function to batch verify eligible commissions
...
-- 6. Update record_affiliate_signup to set commission as 'unverified'
