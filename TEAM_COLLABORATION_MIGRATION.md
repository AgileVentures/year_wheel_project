...
Run this SQL in your Supabase SQL Editor to add team collaboration features.
...
create index year_wheels_team_id_idx on public.year_wheels(team_id);
...
This will add all the necessary tables and policies for team collaboration!
